      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6"
          />
        </div>
        <button
          type="submit"
          className="w-full mb-6 bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg focus:bg-blue-700 active:shadow-lg active:bg-blue-800"
        >
          Create Listing
        </button>
      </form>
